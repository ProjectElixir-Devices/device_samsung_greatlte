...
git clone https://github.com/8890q/android_kernel_samsung_universal8895.git -b lineage-21 kernel/samsung/universal8895 --depth 1 --single-branch
...
git clone https://github.com/ProjectElixir-Devices/hardware_samsung hardware/samsung --depth 1 -b UNO
